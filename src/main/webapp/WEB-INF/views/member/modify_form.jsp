      ...
      <div id="section_wrap">
         ...
         <div class="modify_account_form">
            <form action="<c:url value='/member/${loginMember.m_no}' />" name="modify_account_form" method="post">
               ...
               <input type="text" name="m_id" value="${loginMember.m_id}" readonly disabled> <br> <!-- 아이디는 고유값이기때문 -->
               <input type="password" name="m_pw" value="******" readonly disabled> <br> <!-- 이메일로 보내서 바꿀거임 -->
